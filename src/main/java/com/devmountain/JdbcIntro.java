...
public class JdbcIntro {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Connection connection = ds.getConnection("postgres", "password");
            ...
            if (connection.isValid(500)) {
                ...
                resultSet = statement.executeQuery("SELECT * FROM foods WHERE name = 'salad';");
                System.out.println("Here is the second test result:");
                while(resultSet.next()) {
                    System.out.println(resultSet.getString(1));
                }
            }
